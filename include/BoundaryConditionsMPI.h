...
public:
    ...
    void applyBoundaryConditions(int rank, int size, std::vector<std::vector<double>>& K_global, std::vector<double>& F, const std::vector<int>& fixedNodes, const std::vector<Load>& loads);
};
